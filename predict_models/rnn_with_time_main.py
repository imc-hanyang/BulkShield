"""
RNN with Time Delta Context Training Script

This module implements the training pipeline for time-aware RNN fraud detection.
...
Architecture:
    ...
    - RNNWithTime: RNN model with time delta embedding layer
...
from models.rnn_with_time_model import RNNWithTime
...
MODEL_NAME = "RNN"
SAVE_DIR_NAME = "rnn_with_time_delta"
LOG_DIR = "/home/srt/workspaces/predict_models/logs/rnn_with_time"
...
def evaluate(model, loader, device):
    ...
    Args:
        model: RNNWithTime model instance.
...
def main():
    ...
    model = RNNWithTime(input_dim, device=device).to(device)
