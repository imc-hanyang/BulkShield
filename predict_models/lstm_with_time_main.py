"""
LSTM with Time Delta Context Training Script

This module implements the training pipeline for time-aware LSTM fraud detection.
...
Architecture:
    ...
    - LSTMWithTime: LSTM model with time delta embedding layer
...
from models.lstm_with_time_model import LSTMWithTime
...
MODEL_NAME = "LSTM"
SAVE_DIR_NAME = "lstm_with_time_delta"
LOG_DIR = "/home/srt/workspaces/predict_models/logs/lstm_with_time"
...
def evaluate(model, loader, device):
    ...
    Args:
        model: LSTMWithTime model instance.
...
def main():
    ...
    model = LSTMWithTime(input_dim, device=device).to(device)
